...
;
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Vue; });\n/* harmony import */ var _src_parser__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./src/parser */ \"./src/parser.js\");\n/* harmony import */ var _src_optimizer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./src/optimizer */ \"./src/optimizer.js\");\n/* harmony import */ var _src_generator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./src/generator */ \"./src/generator.js\");\n/* harmony import */ var _src_vnode__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./src/vnode */ \"./src/vnode.js\");\n/* harmony import */ var _src_helper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./src/helper */ \"./src/helper.js\");\n\n\n\n\n\n\n\nclass Vue {\n  constructor(options) {\n    let el;\n    if(options.el==undefined || (el = document.querySelector(options.el)) == null) {\n      throw new Error('el must be specified in Vue constructor');\n    }\n    this.el = el;\n    this.template = this.el.outerHTML;\n    this.options = options || {};\n    this.context = Object.assign(options.data || {}, {_t: _src_vnode__WEBPACK_IMPORTED_MODULE_3__[\"_t\"], _e: _src_vnode__WEBPACK_IMPORTED_MODULE_3__[\"_e\"], _v: _src_vnode__WEBPACK_IMPORTED_MODULE_3__[\"_v\"]});\n    \n    this.ast = null;\n    this.code = null;\n    this.vnode = null;\n    this.render = null;\n    this.main();\n  }\n\n  main() {\n    this.parseTemplate();\n    this.optimize(this.ast);\n    this.render = this.genCode();\n    this.vnode = this.render.call(this.context)\n    this.paint();\n  }\n\n  genCode() {\n    let code =  'with(this){return ' + Object(_src_generator__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(this.ast) + ';}';\n    code = code.replace(/\\n/g, '');\n    console.log(code);\n    let func = new Function(code);\n    return func;\n  }\n\n  optimize() {\n    Object(_src_optimizer__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(this.ast); \n  }\n\n  parseTemplate() {\n    let parent, stack = [];\n    let _ = this;\n    \n    Object(_src_parser__WEBPACK_IMPORTED_MODULE_0__[\"parseHTML\"])(this.template, {\n      start(tag, attrs, unary) {\n        var node = { type: 1, tag, attrs, unary, parent, children:[] };\n        if(parent && parent.children) {\n          parent.children.push(node);\n        }\n        if(stack.length == 0) {\n          node.isRoot = true;\n          _.ast = node;\n        }\n        if(!node.unary) {\n          stack.push(node);\n          parent =  node;\n        }\n      },\n      end() {\n        parent = parent.parent;\n        stack.pop();\n      },\n      chars(text) {\n        if(parent && parent.children) {\n          // var node = { type: 3, text, parent };\n          var expression;\n          if(expression=Object(_src_parser__WEBPACK_IMPORTED_MODULE_0__[\"parseText\"])(text)) {\n            parent.children.push({ type: 2, text, parent, expression })\n          } else {\n            parent.children.push({ type: 3, text, parent })\n          }\n        }\n      }\n    })\n  }\n\n  paint() {\n    var newNode = _src_helper__WEBPACK_IMPORTED_MODULE_4__[\"default\"].createDOM(this.vnode);\n    let parentNode = this.el.parentElement;\n   \n    parentNode.insertBefore(newNode, this.el)\n  }\n}\n\n// with(this){\n//   return _e(\"div\",\n//   {\"id\":\"app\"},\n//   [\n//     _t(\"\\n    \"),\n//     _e(\"h3\",{},\n//     [\n//       _t(\"hello \"+_v(name))\n//     ]\n//     ),\n//     _t(\"you wanna to goto \"+_v(companyName)+\" in \"+_v(city))\n//   ]\n// );\n// }\n// import Vue from './src/index';\n\n\n//# sourceURL=webpack:///./index.js?");
